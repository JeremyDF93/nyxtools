...
public void OnPluginStart() {
  ...
  RegAdminCmd("nyx_addcond", ConCmd_AddCond, ADMFLAG_CHEATS, "nyx_addcond <#userid|name> <cond>");
  RegAdminCmd("nyx_removecond", ConCmd_RemoveCond, ADMFLAG_CHEATS, "nyx_removecond <#userid|name> <cond>");
