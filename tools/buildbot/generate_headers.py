...
def output_version_headers():
  ...
  with open(os.path.join(OutputFolder, 'nyxtools_version_auto.h'), 'w') as fp:
    fp.write("""
...
#define NYXTOOLS_VERSION_FILE         {2},{3},{4},{6}
  ...
  with open(os.path.join(OutputFolder, 'nyxtools_version_auto.inc'), 'w') as fp:
    fp.write("""
#if defined _nyx_auto_version_included
 #endinput
#endif
